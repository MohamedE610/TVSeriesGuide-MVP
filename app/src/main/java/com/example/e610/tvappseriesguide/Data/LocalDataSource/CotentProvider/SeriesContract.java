...
package com.example.e610.tvappseriesguide.Data.LocalDataSource.CotentProvider;
...
public class SeriesContract {
    ...
    public static final String CONTENT_AUTHORITY = "tv_app.series_guide";
    ...
    public static final class SeriesEntry implements BaseColumns {
        ...
        public static final int COL_SERIES_ID = 1;
        public static final int COL_SERIES_TITLE = 2;
        public static final int COL_SERIES_POSTER_PATH = 3;
        public static final int COL_SERIES_OVERVIEW = 4;
        public static final int COL_SERIES_VOTE_AVERAGE = 5;
        public static final int COL_SERIES_RELEASE_DATE = 6;
